...
#Region " Batch Update " 
	...
	public Shared Sub BatchUpdate( DS as Dataset, optional Byval pTransac as TransactionManager = Nothing )
		...
		Try
			...
			cmdInsert.CommandText = "INSERT INTO SccCuentaPorCobrarDetalle ( objSccCuentaPorCobrarID, Mes, MontoInicial, MontoPagado, FechaVencimiento, objEstadoID, objBecaID, FechaCreacion, UsuarioCreacion, FechaModificacion, UsuarioModificacion, Activo) VALUES ( @objSccCuentaPorCobrarID, @Mes, @MontoInicial, @MontoPagado, @FechaVencimiento, @objEstadoID, @objBecaID, @FechaCreacion, @UsuarioCreacion, @FechaModificacion, @UsuarioModificacion, @Activo)"
			...
			cmdUpdate.CommandText = "UPDATE SccCuentaPorCobrarDetalle SET objSccCuentaPorCobrarID=@objSccCuentaPorCobrarID, Mes=@Mes, MontoInicial=@MontoInicial, MontoPagado=@MontoPagado, FechaVencimiento=@FechaVencimiento, objEstadoID=@objEstadoID, objBecaID=@objBecaID, FechaCreacion=@FechaCreacion, UsuarioCreacion=@UsuarioCreacion, FechaModificacion=@FechaModificacion, UsuarioModificacion=@UsuarioModificacion, Activo=@Activo WHERE SccCuentaPorCobrarDetalleID= @wSccCuentaPorCobrarDetalleID"
...
#Region " Insert "
	...
	Public Sub Insert(Optional ByRef pTransac As TransactionManager = Nothing)
        ...
        End If
		arParams(7) = New SqlParameter("@objBecaID", SqlDbType.Int)		
		If IsDBNull(m_objBecaID) Then
            arParams(7).Value = DBNull.Value
        Else
            arParams(7).Value = m_objBecaID
        End If
