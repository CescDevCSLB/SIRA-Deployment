...
#Region " Variables Miembro " 
	...
	Protected m_EsPagoPrestamo As Nullable(Of Boolean) 
...
#Region " Propiedades "
	...
	Public Property EsPagoPrestamo() As Nullable(Of Boolean)
        Get
            Return (m_EsPagoPrestamo)
        End Get
		Set(ByVal Value As Nullable(Of Boolean))					
			m_EsPagoPrestamo = Value
		End Set
    End Property
...
#Region " Batch Update " 
	...
	public Shared Sub BatchUpdate( DS as Dataset, optional Byval pTransac as TransactionManager = Nothing )
		...
		Try
			...
			cmdUpdate.Parameters.Add("@EsPagoPrestamo", SqlDbType.Bit, 1, "EsPagoPrestamo")
    ...
    Public Function Retrieve(Byval p_SccReciboCajaID as Integer, optional Byval pTransac as TransactionManager = Nothing) As Boolean
        ...
        Try
			...
			If dr.Read() Then
				...
				m_EsPagoPrestamo = IIf(IsDBNull(dr("EsPagoPrestamo")), Nothing, dr("EsPagoPrestamo"))
...
#Region " Insert "
	...
	Public Sub Insert(Optional ByRef pTransac As TransactionManager = Nothing)
        ...
        End If
		arParams(24) = New SqlParameter("@EsPagoPrestamo", SqlDbType.Bit)		
		If IsDBNull(m_EsPagoPrestamo) Then
            arParams(24).Value = DBNull.Value
        Else
            arParams(24).Value = m_EsPagoPrestamo
        End If
		arParams(25) = New SqlParameter("@objEmpleadoID", SqlDbType.Int)		
		If IsDBNull(m_objEmpleadoID) Then
            arParams(25).Value = DBNull.Value
        Else
            arParams(25).Value = m_objEmpleadoID
        End If
...
#Region " Update "
	...
	Public Sub Update(Optional ByRef pTransac As TransactionManager = Nothing)        		
		...
		sCommand &= "EsPagoPrestamo = @EsPagoPrestamo,"
