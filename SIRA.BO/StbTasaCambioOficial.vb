...
''' <summary>
''' Registra la tasa de cambio oficial del córdoba respecto a las monedas extranjeras.
''' </summary>
...
#Region " Variables Miembro " 
	...
	Protected m_Dia As Nullable(Of Integer) 
...
#Region " Batch Update " 
	...
	public Shared Sub BatchUpdate( DS as Dataset, optional Byval pTransac as TransactionManager = Nothing )
		...
		Try
			...
			cmdInsert.Parameters.Add("@Dia", SqlDbType.Int, 4, "Dia")
			...
			cmdInsert.CommandText = "INSERT INTO StbTasaCambioOficial ( Mes, Anio, Dia, Fecha, Monto, objMonedaID, UsuarioCreacion, FechaCreacion, UsuarioModificacion, FechaModificacion, objEstadoID) VALUES ( @Mes, @Anio, @Dia, @Fecha, @Monto, @objMonedaID, @UsuarioCreacion, @FechaCreacion, @UsuarioModificacion, @FechaModificacion, @objEstadoID)"

			'CREACION DEL COMANDO UPDATE
			cmdUpdate.Parameters.Add("@Mes", SqlDbType.Int, 4, "Mes")
			cmdUpdate.Parameters.Add("@Anio", SqlDbType.Int, 4, "Anio")
			cmdUpdate.Parameters.Add("@Dia", SqlDbType.Int, 4, "Dia")
			...
			cmdUpdate.CommandText = "UPDATE StbTasaCambioOficial SET Mes=@Mes, Anio=@Anio, Dia=@Dia, Fecha=@Fecha, Monto=@Monto, objMonedaID=@objMonedaID, UsuarioCreacion=@UsuarioCreacion, FechaCreacion=@FechaCreacion, UsuarioModificacion=@UsuarioModificacion, FechaModificacion=@FechaModificacion, objEstadoID=@objEstadoID WHERE StbTasaCambioOficialID= @wStbTasaCambioOficialID"
    ...
    Public Function Retrieve(Byval p_StbTasaCambioOficialID as Integer, optional Byval pTransac as TransactionManager = Nothing) As Boolean
        ...
        Try
			...
			If dr.Read() Then
				...
				m_Dia = IIf(IsDBNull(dr("Dia")), Nothing, dr("Dia"))
...
#Region " Insert "
	...
	Public Sub Insert(Optional ByRef pTransac As TransactionManager = Nothing)
		...
		arParams(1) = New SqlParameter("@Mes", SqlDbType.Int)		
        ...
        End If
		arParams(3) = New SqlParameter("@Dia", SqlDbType.Int)		
		If IsDBNull(m_Dia) Then
            arParams(3).Value = DBNull.Value
        Else
            arParams(3).Value = m_Dia
        End If
