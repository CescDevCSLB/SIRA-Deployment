...
Partial Public Class SContChequeDetalle		

#Region " Variables Miembro " 
	Protected m_SContChequeDetalleID As Integer 
	Protected m_objSContChequeID As Nullable(Of Integer) 
	Protected m_SContCuentaContablesID As Nullable(Of Integer) 
...
#Region " Propiedades "
	Public Property SContChequeDetalleID() As Integer
        Get
            Return (m_SContChequeDetalleID)
        End Get
		Set(ByVal Value As Integer)					
			m_SContChequeDetalleID = Value
		End Set
    End Property
	
	Public Property objSContChequeID() As Nullable(Of Integer)
        Get
            Return (m_objSContChequeID)
        End Get
		Set(ByVal Value As Nullable(Of Integer))					
			m_objSContChequeID = Value
		End Set
    End Property
	
	Public Property SContCuentaContablesID() As Nullable(Of Integer)
        Get
            Return (m_SContCuentaContablesID)
        End Get
		Set(ByVal Value As Nullable(Of Integer))					
			m_SContCuentaContablesID = Value
		End Set
    End Property
		...
		Set(ByVal Value As String)		
			If Not Value Is Nothing Then
				If Value.Length > 50 Then
					Throw New ArgumentOutOfRangeException("UsuarioCreacion", Value.ToString(), "Valor inv?lido para SContChequeDetalle.UsuarioCreacion. La longitud del valor (" & Value.Length & ") excede la longitud m?xima de la propiedad (50).")
				End If
			End If
	...
	Public Property UsuarioModificacion() As String
		...
		Set(ByVal Value As String)		
			If Not Value Is Nothing Then
				If Value.Length > 50 Then
					Throw New ArgumentOutOfRangeException("UsuarioModificacion", Value.ToString(), "Valor inv?lido para SContChequeDetalle.UsuarioModificacion. La longitud del valor (" & Value.Length & ") excede la longitud m?xima de la propiedad (50).")
				End If
			End If
...
#Region " Batch Update " 
	''' <summary>
    ''' Salva un DataSet del tipo de la tabla SContChequeDetalle en la base de datos.
    ''' </summary>
    ''' <param name="DS">Dataset a salvar. El DS debe necesariamente ser un select a la tabla SContChequeDetalle </param>    
	...
	public Shared Sub BatchUpdate( DS as Dataset, optional Byval pTransac as TransactionManager = Nothing )
		...
		Try
			...
			cmdDelete.Parameters.Add("@SContChequeDetalleID", SqlDbType.Int, 4, "SContChequeDetalleID" )
			cmdDelete.CommandText = "DELETE FROM  SContChequeDetalle WHERE SContChequeDetalleID= @SContChequeDetalleID" 	

			'CREACION DEL COMANDO INSERT
			cmdInsert.Parameters.Add("@objSContChequeID", SqlDbType.Int, 4, "objSContChequeID")
			cmdInsert.Parameters.Add("@SContCuentaContablesID", SqlDbType.Int, 4, "SContCuentaContablesID")
			...
			cmdInsert.CommandText = "INSERT INTO SContChequeDetalle ( objSContChequeID, SContCuentaContablesID, objCentroCostoID, MontoAcreditar, MontoDebitar, FechaCreacion, UsuarioCreacion, FechaModificacion, UsuarioModificacion, Saldo, SaldoInicial, SaldoFInal, FechaContabilizacion, SaldoFInalCC, SaldoInicialCC) VALUES ( @objSContChequeID, @SContCuentaContablesID, @objCentroCostoID, @MontoAcreditar, @MontoDebitar, @FechaCreacion, @UsuarioCreacion, @FechaModificacion, @UsuarioModificacion, @Saldo, @SaldoInicial, @SaldoFInal, @FechaContabilizacion, @SaldoFInalCC, @SaldoInicialCC)"

			'CREACION DEL COMANDO UPDATE
			cmdUpdate.Parameters.Add("@objSContChequeID", SqlDbType.Int, 4, "objSContChequeID")
			cmdUpdate.Parameters.Add("@SContCuentaContablesID", SqlDbType.Int, 4, "SContCuentaContablesID")
			...
			cmdUpdate.Parameters.Add("@wSContChequeDetalleID", SqlDbType.Int, 4, "SContChequeDetalleID")
			cmdUpdate.CommandText = "UPDATE SContChequeDetalle SET objSContChequeID=@objSContChequeID, SContCuentaContablesID=@SContCuentaContablesID, objCentroCostoID=@objCentroCostoID, MontoAcreditar=@MontoAcreditar, MontoDebitar=@MontoDebitar, FechaCreacion=@FechaCreacion, UsuarioCreacion=@UsuarioCreacion, FechaModificacion=@FechaModificacion, UsuarioModificacion=@UsuarioModificacion, Saldo=@Saldo, SaldoInicial=@SaldoInicial, SaldoFInal=@SaldoFInal, FechaContabilizacion=@FechaContabilizacion, SaldoFInalCC=@SaldoFInalCC, SaldoInicialCC=@SaldoInicialCC WHERE SContChequeDetalleID= @wSContChequeDetalleID"
			...
			sqlHelper.UpdateDataset (cmdInsert, cmdDelete, cmdUpdate, DS, "SContChequeDetalle")
...
#Region " Retrieve "
	''' <summary>
    ''' Devuelve de la base de datos un objeto SContChequeDetalle
    ''' </summary>    
	''' <param name="pTransac">Opcional. La transacci?n en cuyo ?mbito ser? ejecutado el m?todo Retrieve.</param>    	
    Public Function Retrieve(Byval p_SContChequeDetalleID as Integer, optional Byval pTransac as TransactionManager = Nothing) As Boolean
        Dim sSQL As String = "select * from SContChequeDetalle where " & " SContChequeDetalleID = " & p_SContChequeDetalleID		
        ...
        Try
			...
			If dr.Read() Then
				m_SContChequeDetalleID = dr("SContChequeDetalleID")
				m_objSContChequeID = IIf(IsDBNull(dr("objSContChequeID")), Nothing, dr("objSContChequeID"))
				m_SContCuentaContablesID = IIf(IsDBNull(dr("SContCuentaContablesID")), Nothing, dr("SContCuentaContablesID"))
	...
	''' <summary>
    ''' Devuelve de la base de datos un objeto SContChequeDetalle usando un filter.
    ''' </summary>
    ''' <param name="pFilter">Filtro a aplicar en el select que carga la clase</param>    
	''' <param name="pTransac">Opcional. La transacci?n en cuyo ?mbito ser? ejecutado el m?todo Retrieve.</param>    
    Public Function RetrieveByFilter(ByVal pFilter as String, optional Byval pTransac as TransactionManager = Nothing) As Boolean
        Dim sSQL As String = "select * from SContChequeDetalle where " & pFilter				
        Dim dr As SqlDataReader = Nothing
	...
	''' <summary>
    ''' Trae de la base de datos un conjunto de objetos SContChequeDetalle en un objeto DataTable
    ''' </summary>
    ''' <param name="sFilter">Condici?n que filtra los objetos a traer (WHERE)</param>
    ''' <param name="OrderBy">Campos por los que se ordenar? la salida</param>
    ''' <returns></returns> 
    Public Shared Function RetrieveDT(Optional ByVal sFilter As String = "", Optional ByVal OrderBy As String = "", Optional Byval pFields as String = "*", optional Byval pTransac as TransactionManager = Nothing) As DataTable
        Dim sSQL As String = "select " & pFields &" from SContChequeDetalle"
		...
		Try
			...
			End If
			ds.Tables(0).TableName = "SContChequeDetalle"
			Return (ds.Tables(0))
		Catch ex As Exception
			Throw        
        End Try		
	...
	''' <summary>
    ''' Trae de la base de datos un conjunto de objetos SContChequeDetalle en un objeto DataSet
    ''' </summary>
    ''' <param name="sFilter">Condici?n que filtra los objetos a traer (WHERE)</param>
    ''' <param name="OrderBy">Campos por los que se ordenar? la salida</param>
    ''' <returns></returns> 
    ...
    ''' <summary>
    ''' Trae de la base de datos un conjunto de objetos SContChequeDetalle en un objeto DataReader
    ''' </summary>
    ''' <param name="sFilter">Condici?n que filtra los objetos a traer (WHERE)</param>
    ''' <param name="OrderBy">Campos por los que se ordenar? la salida</param>
    ''' <returns></returns>
...
#Region " Insert "
	...
	''' <summary>
    ''' 	Inserta en la base de datos una nueva instancia de la clase SContChequeDetalle.
    ''' </summary>	
    ''' <param name="pTransac">Opcional. La transacci?n en cuyo ?mbito ser? ejecutado el m?todo Insert.</param>
    ''' <remarks></remarks>
	Public Sub Insert(Optional ByRef pTransac As TransactionManager = Nothing)
		Dim sCommand As String = "insert into SContChequeDetalle("
		sCommand &= "objSContChequeID,"
		sCommand &= "SContCuentaContablesID,"
		...
		sCommand &= " select "
		sCommand &= "@SContChequeDetalleID = SContChequeDetalleID from SContChequeDetalle where "		
		sCommand &= "SContChequeDetalleID = SCOPE_IDENTITY()"
		
		
		Dim arParams(15) As SqlParameter
		arParams(0) = New SqlParameter("@SContChequeDetalleID", SqlDbType.Int)		
		arParams(0).Direction = ParameterDirection.Output
		arParams(1) = New SqlParameter("@objSContChequeID", SqlDbType.Int)		
		If IsDBNull(m_objSContChequeID) Then
            arParams(1).Value = DBNull.Value
        Else
            arParams(1).Value = m_objSContChequeID
        End If
		arParams(2) = New SqlParameter("@SContCuentaContablesID", SqlDbType.Int)		
		If IsDBNull(m_SContCuentaContablesID) Then
            arParams(2).Value = DBNull.Value
        Else
            arParams(2).Value = m_SContCuentaContablesID
        End If
		...
		Try
			...
			m_SContChequeDetalleID = arParams(0).Value
        Catch ex As Exception
            Throw        
        End Try
    End Sub	
...
#Region " Update "
	...
	''' <summary>
    ''' 	Actualiza el objeto SContChequeDetalle en la base de datos.
    ''' </summary>	
    ''' <param name="pTransac">Opcional. La transacci?n en cuyo ?mbito ser? ejecutado el Update del objeto.</param>
    ''' <remarks></remarks>
	Public Sub Update(Optional ByRef pTransac As TransactionManager = Nothing)        		
		Dim sCommand As String = "update SContChequeDetalle set "		
		sCommand &= "objSContChequeID = @objSContChequeID,"
		sCommand &= "SContCuentaContablesID = @SContCuentaContablesID,"
		...
		sCommand &= " where "	
		sCommand &= "SContChequeDetalleID = @SContChequeDetalleID"					
		
		Dim arParams(15) As SqlParameter
		arParams(0) = New SqlParameter("@SContChequeDetalleID", SqlDbType.Int)		
		If IsDBNull(m_SContChequeDetalleID) Then
            arParams(0).Value = DBNull.Value
        Else
            arParams(0).Value = m_SContChequeDetalleID
        End If
		arParams(1) = New SqlParameter("@objSContChequeID", SqlDbType.Int)		
		If IsDBNull(m_objSContChequeID) Then
            arParams(1).Value = DBNull.Value
...
#Region " Delete "
	...
	''' <summary>
    ''' Borra un objeto SContChequeDetalle de la base de datos.
	''' <param name="pTransac">Opcional. La transacci?n en cuyo ?mbito ser? ejecutado el Update del objeto.</param>
    ''' </summary>    
    Public Sub Delete(optional Byval pTransac as TransactionManager = Nothing)
		Try
			Dim sSQL As String = "delete from SContChequeDetalle where " & " SContChequeDetalleID = " & m_SContChequeDetalleID
			If pTransac Is Nothing Then
    ...
    ''' Borra un objeto SContChequeDetalle de la base de datos
    ''' </summary>    
    Public Shared Sub Delete(Byval p_SContChequeDetalleID as Integer, optional Byval pTransac as TransactionManager = Nothing)
		Try
			Dim sSQL As String = "delete from SContChequeDetalle where " & " SContChequeDetalleID = " & p_SContChequeDetalleID
			If pTransac Is Nothing Then
				SqlHelper.ExecuteNonQuery(CommandType.Text, sSQL)
			Else
				SqlHelper.ExecuteNonQuery(pTransac.Transaction, CommandType.Text, sSQL)
    ...
    ''' <summary>
    ''' Borra objetos SContChequeDetalle de la base de datos en base al par?metro WHERE
    ''' </summary>
    ''' <param name="pWhere">Condici?n usada para borrar los objetos de la base de datos.</param>
	''' <param name="pTransac">Opcional. La transacci?n en cuyo ?mbito ser? ejecutado el Update del objeto.</param>
    Public Shared Sub DeleteByFilter(Byval pWhere as String, optional Byval pTransac as TransactionManager = Nothing)
		Try
			Dim sSQL As String = "delete from SContChequeDetalle where " & pWhere
			If pTransac Is Nothing Then
				SqlHelper.ExecuteNonQuery(CommandType.Text, sSQL)
			Else
				SqlHelper.ExecuteNonQuery(pTransac.Transaction, CommandType.Text, sSQL)
