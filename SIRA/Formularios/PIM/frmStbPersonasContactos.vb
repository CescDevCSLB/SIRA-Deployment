            ...
            Select Case frmLLamado
                Case 0
                    Select Case TipoPersona
                        Case 0
                            ...
                            Next
                            frmStbAlumnosEdit.dtContactos.Rows.Add(1, intSecuencialContacto, Me.cmbTipoPersona.SelectedValue, Me.cmbTipoPersona.SelectedText, Me.txtValor.Text)

                        Case 1
                            For Each dr As DataRow In frmStbAlumnosEdit.dtContactosMadre.Rows
                                intSecuencialContacto = dr("SecuencialContacto") + 1
                            Next
                            frmStbAlumnosEdit.dtContactosMadre.Rows.Add(1, intSecuencialContacto, Me.cmbTipoPersona.SelectedValue, Me.cmbTipoPersona.SelectedText, Me.txtValor.Text)

                        Case 2
                            For Each dr As DataRow In frmStbAlumnosEdit.dtContactosResponsable.Rows
                                intSecuencialContacto = dr("SecuencialContacto") + 1
                            Next
                            frmStbAlumnosEdit.dtContactosResponsable.Rows.Add(1, intSecuencialContacto, Me.cmbTipoPersona.SelectedValue, Me.cmbTipoPersona.SelectedText, Me.txtValor.Text)

                        Case 3
                            For Each dr As DataRow In frmStbEmpleadosEditar.dtContactos.Rows
                                intSecuencialContacto = dr("SecuencialContacto") + 1
                            Next
                            frmStbEmpleadosEditar.dtContactos.Rows.Add(1, intSecuencialContacto, Me.cmbTipoPersona.SelectedValue, Me.cmbTipoPersona.SelectedText, Me.txtValor.Text)
                ...
                Case 1
                    For Each dr As DataRow In frmStbProfesorEditar.dtContactos.Rows
                        intSecuencialContacto = dr("SecuencialContacto") + 1
                    Next
                    frmStbProfesorEditar.dtContactos.Rows.Add(1, intSecuencialContacto, Me.cmbTipoPersona.SelectedValue, Me.cmbTipoPersona.SelectedText, Me.txtValor.Text)
