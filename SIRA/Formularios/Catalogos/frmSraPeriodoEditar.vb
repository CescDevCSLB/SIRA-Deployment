...
Public Class frmSraPeriodoEditar
...
#Region "Carga de Datos"
    ...
    Public Sub CargarDatosPeriodo()
        Dim objPeriodo As SraPeriodos
        Try
            objPeriodo = New SraPeriodos
...
#Region "Configruacion"
    ...
    Public Sub ConfigurarGUI()
        Select Case TypeGui
            Case 1
                Me.Text = "Nuevo Período"
                Me.chkActivo.Enabled = False
                Me.chkActivo.Checked = True

            Case 2
                Me.Text = "Editar Período"
                Me.chkActivo.Enabled = True
                Me.CargarDatosPeriodo()
            Case 3
                Me.Text = "Consultar Período"
                Me.CargarDatosPeriodo()
...
#Region "Guardar Periodo"
    ...
    Public Sub CrearPeriodo(ByVal T As DAL.TransactionManager)
        Dim objPeriodo As SraPeriodos
        Dim objMeses As ScontMesCerrado
        Try
            objPeriodo = New SraPeriodos
