...
Public Class frmStbProfesorEditar
...
#Region "Busqueda"
    ...
    Public Sub VincularControles()
        Try
            ...
            'Cargar Contactos
            frmStbAlumnosEdit.dtContactos = DAL.SqlHelper.ExecuteQueryDT(clsConsultas.ObtenerConsultaGeneral("objPersonaID,SecuencialContacto,objTipoEntradaID,TipoEntrada,Valor", "vwPersonaContactos", "objPersonaID=" & Me.idpersona))
            Me.tdbContactos.SetDataBinding(frmStbAlumnosEdit.dtContactos, "", True)
...
#Region "Asociar Personas"
    Private Sub AsociarPersonaClientes()
        ...
        Dim objProfesor, objComparaProfesor As StbProfesores
        ...
        Try
            ...
            ''Insertar Profesor
            objProfesor.objEmpleadoID = objEmpleado.StbEmpleadoID
            objProfesor.UsuarioCreacion = clsProyecto.Conexion.Usuario
            objProfesor.FechaCreacion = clsProyecto.Conexion.FechaServidor
            objProfesor.Insert(T)
...
#Region "Insertar Personas"
    Private Sub InsertarPersonas()
        ...
        Try
            ...
            ObjProfesores.objModalidadID = cmbModalidad.SelectedValue
...
#Region "Insertar Detalle de Personas"
    ...
    Private Sub InsertarDetalle(ByVal IDGenerado As String, t As TransactionManager)
        ...
        Try
            ...
            'Guardar Contactos
            For Each dr As DataRow In frmStbProfesorEditar.dtContactos.Rows
...
#Region "Cargar Datos a Editar"
    ...
    Private Sub CargarDatosEditar()
        ...
        Try
            ...
            chkActivo.Checked = objProfesor.Activo

            If Not IsNothing(objProfesor.objModalidadID) Then
                Me.cmbModalidad.SelectedValue = objProfesor.objModalidadID
            End If
...
#Region "Modificar Personas"
    Private Sub ModificarPersonas()
        ...
        Try
            ...
            ObjProfesores.objModalidadID = cmbModalidad.SelectedValue
            ObjProfesores.Activo = chkActivo.Checked
...
#Region "Cargar Grid Contactos"
    Private Sub CargarGridContactos()
        Try
            ...
            frmStbProfesorEditar.dtContactos = DAL.SqlHelper.ExecuteQueryDT(clsConsultas.ObtenerConsultaGeneral("objPersonaID,SecuencialContacto,objTipoEntradaID,TipoEntrada,Valor", "vwPersonaContactos", strFiltro))
            Me.tdbContactos.SetDataBinding(frmStbProfesorEditar.dtContactos, "", True)
            Me.tdbContactos.Caption = "Contactos (" & frmStbProfesorEditar.dtContactos.Rows.Count & ")"

            If frmStbProfesorEditar.dtContactos.Rows.Count = 0 Then
                Me.cmdEliminarContacto.Enabled = False
            Else
                Me.cmdEliminarContacto.Enabled = True
            End If
...
#Region "Cargar el Formulario"
    ...
    Private Sub frmStbPersonasEditar_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Select Case Me.TyGui
                Case 1
                    Me.Text = "Agregar Nuevo Profesor"
                Case 2
                    Me.Text = "Editanto datos del Profesor: " & Me.idpersona
                    Me.CargarDatosEditar()
                    Me.txtPrimerNombre.Focus()
                    Me.cmdBuscar.Enabled = False
                Case 3
                    Me.Text = "Consultando datos del Profesor: " & Me.idpersona
    ...
    Private Sub cmdBuscar_Click(sender As Object, e As EventArgs) Handles cmdBuscar.Click
        Try
            Dim objSeleccion As frmGrupoSelector
            objSeleccion = New frmGrupoSelector
            objSeleccion.Filtro = "  StbPersonaID NOT IN (SELECT objPersonaID FROM StbProfesores) "
