...
#Region "Incializar GUI"
    ...
    Public Sub CargarGrid()
        Try
            ...
            dtCheques = DAL.SqlHelper.ExecuteQueryDT(ObtenerConsultaGeneral("ScontChequeID, Moneda, NumCheque, Fecha, Concepto, Activo, Beneficiario, ValorCordobas,Notas, objEstadoChequeID, Estado", "vwSContCheques", ))
            dtCheques.PrimaryKey = New DataColumn() {Me.dtCheques.Columns("ScontChequeID")}
            dtCheques.DefaultView.Sort = "ScontChequeID desc"
            Me.grdPeriodo.DataSource = dtCheques
            Me.grdPeriodo.Text = "Cheques (" & Me.dtCheques.Rows.Count & ")"
    ...
    Public Sub CargarGridBusqueda(strfiltro As String)
        Try
            dtCheques = DAL.SqlHelper.ExecuteQueryDT(ObtenerConsultaGeneral("ScontChequeID, Moneda, NumCheque, Fecha, Concepto, Activo, Beneficiario, ValorCordobas,Notas, objEstadoChequeID, Estado", "vwSContCheques", strfiltro))
            dtCheques.PrimaryKey = New DataColumn() {Me.dtCheques.Columns("ScontChequeID")}
            dtCheques.DefaultView.Sort = "ScontChequeID desc"
            Me.grdPeriodo.DataSource = dtCheques
            Me.grdPeriodo.Text = "Cheques (" & Me.dtCheques.Rows.Count & ")"
...
#Region "Procedimientos"
    Private Sub Editar()
        ...
        Dim ConsultarPeriodo As New frmScontChequesEdit
                ...
                If FilaActual >= 0 Then
                    ...
                    Else
                        ...
                        Else
                            ...
                            If Me.dtCheques.DefaultView.Item(FilaActual)("objEstadoChequeID").ToString.Trim.Length <> 0 Then
                                If Me.dtCheques.DefaultView.Item(FilaActual)("objEstadoChequeID") <> IDEstadoRegistrado Then
                                    MsgBox("Solamente Cheques en estado REGISTRADO pueden ser Editados", MsgBoxStyle.Critical, clsProyecto.SiglasSistema)
                                    Exit Sub
                                End If
                            Else
                                MsgBox("No ha sido posible cargar el Identificador de estado (objEstadoChequeID) del cheque.", MsgBoxStyle.Critical, clsProyecto.SiglasSistema)
                                Exit Sub
                            End If

                            ConsultarPeriodo.ChqeueID = Me.dtCheques.DefaultView.Item(FilaActual)("ScontChequeID")
...
#Region "Eventos del Formulario"
    ...
    Private Sub Contabilizar(periodo As Integer)
        ...
        Try
            ...
            If FilaActual >= 0 Then
                ...
                If Me.dtCheques.DefaultView.Item(FilaActual)("ScontChequeID").ToString.Trim.Length <> 0 Then
                    ...
                    parametro(1).Value = Me.dtCheques.DefaultView.Item(FilaActual)("ScontChequeID")
                    ...
                    MsgBox("Cheque contabilizado correctamente.", MsgBoxStyle.Information + MsgBoxStyle.OkOnly, clsProyecto.SiglasSistema)
        ...
        Try
            ...
            If FilaActual >= 0 Then
                ...
                If Me.dtCheques.DefaultView.Item(FilaActual)("ScontChequeID").ToString.Trim.Length <> 0 Then
                    ...
                    parametro(0) = New SqlClient.SqlParameter("@IDCheque ", SqlDbType.Int, 4)
                    parametro(0).Value = Me.dtCheques.DefaultView.Item(FilaActual)("ScontChequeID")

                    parametro(1) = New SqlClient.SqlParameter("@Usuario", SqlDbType.VarChar)
                    parametro(1).Value = clsProyecto.Conexion.Usuario

                    SqlHelper.ExecuteNonQuery(CommandType.StoredProcedure, "Sp_AnularCheque", parametro)
                    MsgBox("Cheque anulado correctamente", MsgBoxStyle.Information + MsgBoxStyle.OkOnly, clsProyecto.SiglasSistema)
    ...
    Private Sub cmdAgregar_Click(sender As Object, e As EventArgs) Handles cmdAgregar.Click
        Dim editperiodo As frmScontChequesEdit
        Dim objTasaCambio As StbTasaCambioOficial
        Dim objPeriodo As SContPeriodos
        Dim intPeriodo As Integer
        Try
            Me.Cursor = WaitCursor
            editperiodo = New frmScontChequesEdit
            objTasaCambio = New StbTasaCambioOficial
            objPeriodo = New SContPeriodos
            ...
            Else
                objPeriodo.RetrieveByFilter("Activo=1 AND (Cerrado=0 or Cerrado is null)")
                If objPeriodo.SContPeriodoID = 0 Then
                    MsgBox("No existe un período activo, para generar cheques.", MsgBoxStyle.Critical, clsProyecto.SiglasSistema)
                Else
                    intPeriodo = objPeriodo.SContPeriodoID
    ...
    Private Sub cmdImprimir_Click(sender As Object, e As EventArgs) Handles cmdImprimir.Click
        ...
        Try
            ...
            If FilaActual >= 0 Then
                ds = DAL.SqlHelper.ExecuteQueryDS(ObtenerConsultaGeneral("Empresa, DireccionEmpresa, TelefonosEmpresa, EmailEmpresa, Fecha, NumCheque, ScontChequeID, FechaComprobante, Concepto, IDCuenta, Cuenta, MontoAcreditar, MontoDebitar, CentroCosto, Beneficiario,Notas", "vwRptComprobanteCheque", "ScontChequeID=" & Me.dtCheques.DefaultView.Item(FilaActual)("ScontChequeID")))
    ...
    Private Sub cmdContabilizar_Click(sender As Object, e As EventArgs) Handles cmdContabilizar.Click
        ...
        Try
            ...
            If Me.dtCheques.DefaultView.Item(FilaActual)("objEstadoChequeID").ToString.Trim.Length <> 0 Then
                If Me.dtCheques.DefaultView.Item(FilaActual)("objEstadoChequeID") <> IDEstadoRegistrado Then
                    MsgBox("Solamente Cheques en estado REGISTRADO pueden ser contabilizados", MsgBoxStyle.Critical, clsProyecto.SiglasSistema)
                    Exit Sub
                End If
            Else
                MsgBox("No ha sido posible cargar el Identificador de estado (objEstadoChequeID) del cheque.", MsgBoxStyle.Critical, clsProyecto.SiglasSistema)
            ...
            Select Case MsgBox("¿Está seguro que desea contablizar el cheque seleccionado?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, clsProyecto.SiglasSistema)
    ...
    Private Sub cmdInactivar_Click(sender As Object, e As EventArgs) Handles cmdInactivar.Click
        Dim objPeriodo As New ScontCheque
        Dim intPeriodo As Integer
        Dim FilaActual As Integer
        Try
            Me.Cursor = WaitCursor
            ...
            If Me.dtCheques.DefaultView.Item(FilaActual)("objEstadoChequeID").ToString.Trim.Length <> 0 Then
                If Me.dtCheques.DefaultView.Item(FilaActual)("objEstadoChequeID") = IDEstadoAnulado Then
                    MsgBox("Solamente Cheques en estado REGISTRADO o CONTABILIZADO pueden ser anulados", MsgBoxStyle.Critical, clsProyecto.SiglasSistema)
                    Exit Sub
                End If
            Else
                MsgBox("No ha sido posible cargar el Identificador de estado (objEstadoChequeID) del cheque.", MsgBoxStyle.Critical, clsProyecto.SiglasSistema)
            ...
            If Me.dtCheques.DefaultView.Item(FilaActual)("objEstadoChequeID") = IDEstadoContabilizado Then
                Select Case MsgBox("¿Está seguro que desea anular el cheque seleccionado?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, clsProyecto.SiglasSistema)
                    Case MsgBoxResult.Yes
            ...
            Else
                Select Case MsgBox("¿Está seguro que desea anular el cheque seleccionado?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, clsProyecto.SiglasSistema)
                    Case MsgBoxResult.Yes
                        objPeriodo.Retrieve(Me.dtCheques.DefaultView.Item(FilaActual)("ScontChequeID"))
                        ...
                        objPeriodo.objEstadoChequeID = IDEstadoAnulado
                        objPeriodo.Update()
                        CargarGrid()
                        AplicarSeguridad()
        ...
        Try
            Try
                If BuscarCheques.ShowDialog(Me) = Windows.Forms.DialogResult.OK Then
                    strFiltro = "  datepart(year,fecha) = " & BuscarCheques.Periodo & " AND objEstadoChequeID=" & BuscarCheques.EstadoID
    ...
    Private Sub cmdActivar_Click(sender As Object, e As EventArgs)
        ...
        Dim objCheque As New ScontCheque
        Dim FilaActual As Integer
        Try
            Dim selectedRow As Integer() = grdPeriodoTabla.GetSelectedRows()
            FilaActual = Me.grdPeriodoTabla.GetDataSourceRowIndex(selectedRow(0))
            If FilaActual >= 0 Then
                Select Case MsgBox("¿Está seguro de anular el cheque seleccionado?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, clsProyecto.SiglasSistema)
                    Case MsgBoxResult.Yes
                        ChequeID = Me.dtCheques.DefaultView.Item(FilaActual)("ScontChequeID")
