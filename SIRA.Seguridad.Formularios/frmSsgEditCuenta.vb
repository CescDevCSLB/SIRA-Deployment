...
#Region "Metodos Para la Edición de una Cuenta"
    ...
    Private Sub CargarEmpleados()
        Try
            dtEmpleados = DAL.SqlHelper.ExecuteQueryDT(clsConsultas.ObtenerConsultaGeneral("StbEmpleadoID,NombreCompleto as Nombre ,StbPersonaID as StbPersonaID", "vwStbEmpleados", "Activo =1"))

            'dtEmpleados = SrhEmpleado.RetrieveDT(, "Nombre", "SrhEmpleadoID,  NombreCompleto as Nombre")
            dtEmpleados.PrimaryKey = New DataColumn() {Me.dtEmpleados.Columns("StbEmpleadoID")}
            dtEmpleados.DefaultView.Sort = "StbEmpleadoID"
            Me.cboEmpleado.DataSource = dtEmpleados
            Me.cboEmpleado.DisplayMember = "Nombre"
            Me.cboEmpleado.ValueMember = "StbEmpleadoID"
            Me.dtEmpleados.DefaultView.Sort = "Nombre"

            '--- Formatear combo
            '-----------------
            Me.cboEmpleado.Splits(0).DisplayColumns("StbEmpleadoID").Visible = False
            Me.cboEmpleado.Splits(0).DisplayColumns("StbPersonaID").Visible = False
