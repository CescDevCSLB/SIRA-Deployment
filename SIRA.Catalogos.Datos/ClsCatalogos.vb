...
Public Class ClsCatalogos
    ...
    Public Shared Function GetStbTiendaID(ByVal sCodigoTienda As String) As Integer
        Dim sSQL As String
        Dim iResultado As Integer
        sSQL = SIRA.BO.clsConsultas.ObtenerConsultaGeneral("StbBodegaID", "dbo.StbBodegas", "Codigo='" + sCodigoTienda + "'")
        Try
    ...
    Public Shared Function GetStbCajaID(ByVal sCodigoCaja As String) As Integer
        Dim sSQL As String
        Dim iResultado As Integer
        sSQL = SIRA.BO.clsConsultas.ObtenerConsultaGeneral("SccCajaID", "dbo.SccCajas", "Codigo='" + sCodigoCaja + "'")
        Try
    ...
    Public Shared Function GetStbCajaCHID(ByVal sCodigoCaja As String) As Integer
        Dim sSQL As String
        Dim iResultado As Integer
        sSQL = SIRA.BO.clsConsultas.ObtenerConsultaGeneral("SccCajaChicaID", "dbo.SccCajaChica", "Codigo='" + sCodigoCaja + "'")
        Try
            iResultado = DAL.SqlHelper.ExecuteQueryDT(sSQL).DefaultView.Item(0)("SccCajaChicaID")
        Catch ex As Exception
            iResultado = 0
        End Try
        Return iResultado
    ...
    Public Shared Function GetStbTiendaNombre(ByVal sCodigoTienda As String) As String
        ...
        sSQL = SIRA.BO.clsConsultas.ObtenerConsultaGeneral("Nombre", "dbo.StbTienda", "Codigo='" + sCodigoTienda + "'")
        Try
