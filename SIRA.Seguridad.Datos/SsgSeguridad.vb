...
#End Region
    ...
    Public Function Autenticar(ByVal login As String, ByVal clave As String, ByVal UserName As TextBox, ByVal PassWortexto As TextBox) As Boolean
